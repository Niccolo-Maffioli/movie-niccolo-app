...
const bannerFunction = (array: MovieArray): void => {
  const banner = document.getElementById("banner") as HTMLDivElement;
  const overviewContainer = document.getElementById("overviewContainer") as HTMLDivElement;
  const age = document.getElementById("age") as HTMLDivElement;
